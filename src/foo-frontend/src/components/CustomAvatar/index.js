...
class CustomAvatar extends React.Component {
	render() {
		...
		switch (this.props.type) {
			case 'main-avatar':
				return <Gravatar email={this.props.avatar} className={customClassName} default="identicon" />;
			case 'new-avatar':
			...
			case 'user-avatar':
				return <Ravatar name={this.props.avatar} className={customClassName} size="60" />;
			case 'group-avatar':
