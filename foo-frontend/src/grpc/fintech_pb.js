...
proto.fintech.GetStrangerListResponse.serializeBinaryToWriter = function(message, writer) {
	...
	f = message.getData();
	if (f != null) {
		writer.writeMessage(1, f, proto.fintech.GetStrangerListResponse.Data.serializeBinaryToWriter);
	}
	f = message.getStatus();
	if (f != null) {
		writer.writeMessage(2, f, proto.fintech.Status.serializeBinaryToWriter);
...
proto.fintech.GetStrangerListResponse.prototype.getData = function() {
	return /** @type{?proto.fintech.GetStrangerListResponse.Data} */ jspb.Message.getWrapperField(
		this,
		proto.fintech.GetStrangerListResponse.Data,
		1
	);
};
...
proto.fintech.ResetUnseenResponse.serializeBinaryToWriter = function(message, writer) {
	...
	f = message.getStatus();
	if (f != null) {
		writer.writeMessage(1, f, proto.fintech.Status.serializeBinaryToWriter);
	}
};
...
proto.fintech.GetUserInfoResponse.serializeBinaryToWriter = function(message, writer) {
	...
	f = message.getData();
	if (f != null) {
		writer.writeMessage(1, f, proto.fintech.GetUserInfoResponse.Data.serializeBinaryToWriter);
	}
	f = message.getStatus();
	if (f != null) {
		writer.writeMessage(2, f, proto.fintech.Status.serializeBinaryToWriter);
...
proto.fintech.GetUserInfoResponse.prototype.getData = function() {
	return /** @type{?proto.fintech.GetUserInfoResponse.Data} */ jspb.Message.getWrapperField(
		this,
		proto.fintech.GetUserInfoResponse.Data,
		1
	);
};
