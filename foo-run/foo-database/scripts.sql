...
(36) NOT NULL,
  ...
  `description` VARCHAR
(120) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(`receiver` ASC) VISIBLE,
  CONSTRAINT `fk_transactions_users1` FOREIGN KEY
(`sender`) REFERENCES `fooapp`.`users`
(`id`),
  CONSTRAINT `fk_transactions_users2` FOREIGN KEY
(`receiver`) REFERENCES `fooapp`.`users`
(`id`)
) ENGINE = InnoDB DEFAULT CHARACTER
SET = utf8mb4
COLLATE = utf8mb4_unicode_ci;
...
(`transfer_id` ASC) VISIBLE,
  CONSTRAINT `fk_transaction_logs_users` FOREIGN KEY
(`user_id`) REFERENCES `fooapp`.`users`
(`id`),
  CONSTRAINT `fk_transaction_logs_transactions1` FOREIGN KEY
(`transfer_id`) REFERENCES `fooapp`.`transfers`
(`id`)
)ENGINE = InnoDB DEFAULT CHARACTER
SET = utf8mb4
COLLATE = utf8mb4_unicode_ci;
...
(`user_id` ASC) VISIBLE,
  CONSTRAINT `fk_transfer_reminds_users1` FOREIGN KEY
(`user_id`) REFERENCES `fooapp`.`users`
(`id`)
) ENGINE = InnoDB DEFAULT CHARACTER
SET = utf8mb4
...
(`friend_id` ASC) VISIBLE,
  CONSTRAINT `fk_friends_users1` FOREIGN KEY
(`user_id`) REFERENCES `fooapp`.`users`
(`id`),
  CONSTRAINT `fk_friends_users2` FOREIGN KEY
(`friend_id`) REFERENCES `fooapp`.`users`
(`id`)
)ENGINE = InnoDB DEFAULT CHARACTER
SET = utf8mb4
COLLATE = utf8mb4_unicode_ci;
