...
CREATE TABLE IF NOT EXISTS `fooapp`.`transfers` (
  `id` CHAR(36) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL,
  `sender` CHAR(36) NOT NULL,
  `receiver` CHAR(36) NOT NULL,
  `amount` BIGINT NOT NULL,
  `description` VARCHAR(120) COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE IF NOT EXISTS `fooapp`.`account_logs` (
  ...
  CONSTRAINT `fk_transaction_logs_transactions1`
    ...
    REFERENCES `fooapp`.`transfers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
